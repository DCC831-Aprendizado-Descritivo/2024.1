...
<div style="display: flex; justify-content: space-between; align-items: center;">
  <figure style="margin-right: 10px; width: 45%;">
    <img src="imgs/artigo6/sushi.png" style="width: 100%; height: 200px;">
    <figcaption>Fonte: [sushi](https://depositphotos.com/photos/sushi.html)</figcaption>
  </figure>

  <figure style="margin-left: 10px; width: 45%;">
    <img src="imgs/artigo6/movies.jpg" style="width: 100%; height: 200px;">
    <figcaption>Fonte: [movies](https://www.gamesradar.com/star-wars-movies-order-first-chronological/)</figcaption>
  </figure>
</div>
