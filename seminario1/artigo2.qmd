...
[//]: # (por alguma razão inexplicável precisa colocar 2 espaços depois do import e do def abaixo para o quarto gerar a célula de jupyter notebook corretamente)
 ```{python}
import  random
